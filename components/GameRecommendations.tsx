  ...
  const filteredGames = selectedGames
    .map((game) => {
      ...
      if (
        ...
        game.marketingCapabilities.some((cap) =>
      ...
      if (
        game.audience.interests.some((interest) =>
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-[300px] p-3">
                          <p className="text-sm">
                            <strong>Regions:</strong> {game.regions.join(", ")}
                            <br />
                            <strong>Audience:</strong> {game.audience.ageRange}
                            <br />
                            <strong>Marketing:</strong>{" "}
                            {game.marketingCapabilities.join(", ")}
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
